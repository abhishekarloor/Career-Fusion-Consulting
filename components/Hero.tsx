export function Hero() {
  return (
    <section id="home" className="relative bg-cover bg-center bg-no-repeat py-8 md:py-12 overflow-hidden" style={{backgroundImage: 'url("./images/hero-bg.jpg")'}}>
      ...
      {/* Accent Elements */}
      <div className="absolute top-20 right-10 w-72 h-72 bg-[#00A4CC] rounded-full mix-blend-screen filter blur-3xl opacity-5"></div>
      <div className="absolute bottom-0 left-10 w-96 h-96 bg-[#00A4CC] rounded-full mix-blend-screen filter blur-3xl opacity-5"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button className="bg-[#00A4CC] hover:bg-[#0088AA] text-[#003366] font-bold py-4 px-10 rounded-lg transition-all duration-300 shadow-lg hover:shadow-2xl hover:scale-105 transform">
              Explore Our Services
            </button>
            <button className="border-3 border-white text-white hover:bg-white hover:text-[#003366] font-bold py-4 px-10 rounded-lg transition-all duration-300 shadow-lg hover:shadow-2xl hover:scale-105 transform">
              Learn More
            </button>
          </div>
        </div>
